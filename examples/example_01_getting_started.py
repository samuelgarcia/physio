...
resp, resp_cycles = physio.compute_respiration(raw_resp, srate, parameter_preset = 'human_airflow') # set 'human_airflow' as preset
...
# Columns contain cycle-specific features such as duration, amplitude, volume ... (see :ref:`sphx_glr_examples_example_02_respiration.py` for a complete description of the columns).

print(resp_cycles.shape)
print(resp_cycles.columns)

columns = ['cycle_duration', 'inspi_volume', 'expi_volume', 'total_amplitude']
colors = ['tab:blue','darkorange','green','red']
units = ['s','AU','AU','AU']
